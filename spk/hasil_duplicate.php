			...
			<div class="container">
				...
				<div class="nav-wrapper">
					<ul class="left" style="margin-left: -52px;">
						...
						<li><a href="daftar_laptop.php">DAFTAR HP</a></li>
	...
	<div style="background-color: #efefef">
		<div class="container">
			<div class="section-card" style="padding: 20px 0px">
				...
				<center>
					<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #635c73;">HASIL REKOMENDASI PRODUK LAPTOP</h4>
				</center>
				<ul>
					<li>
						<div class="row">
										...
										<tbody>
											...
											while ($data_hp=mysqli_fetch_array($query)) {
												...
												<tr>
													...
													<td><center><?php echo $data_hp['procesor_angka'] ?></center></td>
				...
				<ul>
											...
											while ($data_hp=mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no-1]=array($data_hp['harga_angka']/$pembagiNM[0],
													...
													<tr>
														...
														<td><center><?php echo round($data_hp['procesor_angka']/$pembagiNM[3],6) ?></center></td>
										...
										<table class="responsive-table">
											<thead>
												<tr>
													...
													<th><center>Value Kriteria CPU</center></th>
													<th><center>Value Kriteria Inches</center></th>
												</tr>
											</thead>
											<tbody>
												<!--count($W)-->
					...
					<div class="row center" \>
						<a href="rekomendasi.php" id="download-button" class="waves-effect waves-light btn" style="margin-top: 0px">Hitung Ulang Rekomendasi </a>
					</div>
				</div>
			</div>
		</div>
