...
$result = mysqli_query($conn, "SELECT * FROM pelanggan WHERE level='admin'");

if (isset($_POST["cari"])) {
  $cari = $_POST["keyword"];
  $q = "SELECT * FROM pelanggan WHERE
	(username LIKE '%$cari%' OR email LIKE '%$cari%' OR nama LIKE '%$cari%') AND level='admin'";
...
<head>
  ...
  <title>Jaya Ponsel | List Admin</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="list_admin.php" class="nav-link active">
                    <i class="nav-icon fa fa-book"></i>
                    <p>List Admin</p>
                  </a>
                </li>
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                  ...
                  <td>
                    <a href="edit_anggota.php?id=<?php echo $row['idPelanggan']; ?>" class="btn btn-warning btn-sm">Edit</a>
                    <a href="hapus_anggota.php?id=<?php echo $row['idPelanggan']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                  </td>
                </tr>
              <?php $i++;
              endwhile; ?>
